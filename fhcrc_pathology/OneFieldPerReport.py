...
class OneFieldPerReport(object):
    ...
    file_name_string = ''
    pre_negation = 'r([pP]revious|re[- ]treatment| [pP]ast).{,100}'
    post_negation = r'.{,50}( unlikely| not (likely|identif)| [nN]egative|[Aa]bsent)'
                ...
                if match:
                    ...
                    ## iterate through match iterator for 'all' style fields, which may have multiple matches
                        ...
                        for each_match in match:                            
                            ...
                            if self.file_name_string:
                                # ***** There's a bug to fix here! use bcrp path pull 2014 to test ClinicalHistory matching *****#
                                #print each_match.group(1),'...',each_match.group(2),'...',each_match.group(3)                                
