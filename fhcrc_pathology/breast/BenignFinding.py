...
class BenignFinding(OneFieldPerSpecimen):
    ''' extract other, benign findings (inflammation, etc) '''
    __version__ = 'Benign1.0'
    def __init__(self):
        super(BenignFinding, self).__init__()       
        self.overall_field_name = 'BenignFinding'
        self.overall_table = gb.PATHOLOGY_TABLE
        self.specimen_confidence = 0.9
        self.match_style = 'all'
        ## reference lists & dictionaries ##
        self.file_name_string = 'benign'
